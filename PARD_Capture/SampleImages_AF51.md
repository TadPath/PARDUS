...
Desription
------------
Below are links to some images taken with the AF51 5 megapixel USB 2.0 camera from OptArc using the PAR Capture software. These are large full resolutio (5 megapixel) uncompressed files so may take some time to load depending on your connection speed.
